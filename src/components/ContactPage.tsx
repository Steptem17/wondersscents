...
export const ContactPage: React.FC<ContactPageProps> = () => {
  ...
  return (
    <div className="w-full bg-white text-[#181818] font-sans min-h-screen selection:bg-brand-purple selection:text-white flex flex-col justify-between">
      ...
      {/* ========================================================================= */}
      {/* 3. ACTIVE SUPPORT, PICKUP ADDRESS & CAC VERIFICATION                       */}
      {/* ========================================================================= */}
      <section className="py-14 sm:py-20 px-4 sm:px-8 md:px-12 lg:px-16 bg-white border-b border-black/10">
        <div className="max-w-6xl mx-auto">
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch text-left">
            
            {/* Card 1: Pickup Location & Direct Phone Lines */}
            <ScrollReveal direction="up" delay={40}>
              <div className="p-6 sm:p-7 bg-neutral-50 rounded-2xl border border-black/10 h-full flex flex-col justify-between space-y-4">
                <div className="space-y-3">
                  ...
                  <div className="space-y-1.5 text-xs text-[#181818]/80 leading-relaxed">
                ...
                <div className="pt-3 border-t border-black/5 space-y-1 text-xs text-[#181818]/85">
                  <p>
                    <span className="font-semibold text-[#111111]">Primary:</span>{' '}
                    <a href="https://wa.me/2348145620271" className="text-brand-purple font-medium hover:opacity-80 transition-opacity">+234 814 562 0271</a>
                  </p>
                  <p>
                    <span className="font-semibold text-[#111111]">Alternate:</span>{' '}
                    <a href="tel:09052329788" className="text-brand-purple font-medium hover:opacity-80 transition-opacity">+234 905 232 9788</a>
                  </p>
                </div>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal direction="up" delay={80}>
              <div className="p-6 sm:p-7 bg-neutral-50 rounded-2xl border border-black/10 h-full flex flex-col justify-between space-y-4">
                ...
                <div className="pt-3 border-t border-black/5 text-[11px] text-[#181818]/60 font-medium">
                  Direct WhatsApp concierge active during support hours
                </div>
              </div>
            </ScrollReveal>
              ...
              <div className="p-6 sm:p-7 bg-neutral-50 rounded-2xl border border-black/10 h-full flex flex-col justify-between space-y-4">
                <div className="space-y-3">
                  ...
                  <p className="text-xs text-[#181818]/75 leading-relaxed font-normal">
                    WondersScents is officially registered with the <strong>Corporate Affairs Commission (CAC)</strong> of Nigeria (Incorporated Jan 10, 2023).
                  </p>
                </div>

                <div className="pt-3 border-t border-black/5 flex items-center space-x-1.5 text-emerald-600 text-xs font-semibold">
